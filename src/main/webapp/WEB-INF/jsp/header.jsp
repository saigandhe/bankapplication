...
<body
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-basic">
		...
		<div class="d-flex flex-row-reverse"><a href="updatePasswordMethod">Change Password</a></div>
	</nav>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
			...
			<div class="d-flex flex-row-reverse bd-highlight">
				<ul class="navbar-nav mr-auto">
<!-- 				//<li class="nav-item active"><a class="nav-link" href="home"><b><strong>Home</strong> -->
				<li class="nav-item active"><b><strong><a class="nav-link">Welcome ${sessionScope.customer.customerName}!</a></strong>
