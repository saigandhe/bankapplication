...
<form:form action="updateProfile" class = "p-4" method="post" modelAttribute="customer">
  ...
  <div class="form-group">
    <form:label path="customerEmailId">Email address:</form:label>
    <form:input type="email" class="form-control" path="customerEmailId" />
  </div>
  <div class="form-group">
    <form:label path="customerAddress">Address:</form:label>
    <form:input type="text" class="form-control" path="customerAddress" />
  </div>
   <div class="form-group">
